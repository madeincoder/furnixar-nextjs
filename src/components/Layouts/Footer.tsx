...
import footerBg from '../../../public/images/bg/footer.jpg'

const Footer: React.FC = () => {
  return (
    <div className="relative bg-overlay before:bg-title before:bg-opacity-95"
    style={{ backgroundImage: `url(${footerBg.src})` }}>
        <div className="s-pt-100">
            ...
            <div className="max-w-lg lg:max-w-[1052px] mx-auto flex items-end justify-between gap-3 lg:gap-8 flex-col lg:flex-row s-pb-100">
                ...
                <p className="mt-2 sm:mt-4 text-white-light">
                    Lorem ipsum dolor sit amet, consectetur purus habitasse ut diam.
                    Auctor sit elementum habitant vel tempor varius.{" "}
                </p>
                </div>
                <div className="mt-4 lg:mt-6 sm:flex md:max-w-[478px] w-full">
                <input
                    className="w-full h-12 md:h-14 bg-white bg-opacity-[0.03] border border-white text-white placeholder:text-white-light border-opacity-30 focus:border-primary p-4 outline-none sm:flex-1 sm:border-r-0 duration-300"
                    type="text"
                    placeholder="Enter your email address"
                />
                <button className="w-full h-12 bg-primary text-white flex items-center justify-center text-base md:text-lg font-medium p-3 mt-3 sm:mt-0 sm:w-32 sm:h-auto sm:flex-none">
                    Subscribe
                </button>
                </div>
            </div>
            {/* Main Footer */}
            <div className="max-w-[1722px] mx-auto flex items-start justify-between gap-10 s-pb-100 flex-wrap lg:flex-nowrap">
                <div className="lg:max-w-[366px] sm:w-[45%] lg:w-full flex items-start justify-between gap-10">
                <div className="">
                    ...
                    <li className="duration-100 hover:text-primary inline-block group">
                        <a className="text-underline-primary" href="about.html">
                        About
                        </a>
                    </li>
                    <li className="duration-100 hover:text-primary inline-block group">
                        <a className="text-underline-primary" href="team.html">
                        Team
                        </a>
                    </li>
                    <li className="duration-100 hover:text-primary inline-block group">
                        ...
                        href="protfolio-v1.html"
                        >
                        Protfolio
                        </a>
                    </li>
                    <li className="duration-100 hover:text-primary inline-block group">
                        <a className="text-underline-primary" href="our-clients.html">
                        Clients
                        </a>
                    </li>
                    <li className="duration-100 hover:text-primary inline-block group">
                        <a className="text-underline-primary" href="error.html">
                        Error
                        </a>
                    </li>
                    </ul>
                ...
                <div className="">
                    ...
                    <li className="duration-100 hover:text-primary inline-block group">
                        <a className="text-underline-primary" href="my-profile.html">
                        My Account
                        </a>
                    </li>
                    <li className="duration-100 hover:text-primary inline-block group">
                        <a className="text-underline-primary" href="coming-soon.html">
                        Coming Soon
                        </a>
                    </li>
                    </ul>
                ...
                <Image
                    className="sm:mx-auto w-[150px] sm:w-auto"
                    src={footerLogo}
                    alt="logo"
                    width={150}
                    height={150}
                ...
                <div className="flex items-center sm:justify-center gap-4 mt-6">
                    ...
                    >
                    <svg
                        className="fill-current text-white group-hover:text-primary duration-300 "
                        width={9}
                        height={17}
                        viewBox="0 0 9 17"
                        fill="none"
                    ...
                    >
                    <svg
                        className="fill-current text-white text-opacity-70 group-hover:text-primary duration-300 group-hover:text-opacity-100"
                        width={21}
                        height={17}
                        viewBox="0 0 21 17"
                        fill="none"
                ...
                <div className="lg:max-w-[460px] sm:w-[45%] lg:w-full flex items-start justify-between gap-10">
                <div className="">
                    <h4 className="text-white leading-none mb-5 md:mb-6 text-xl md:text-2xl">
                    Shop
                    </h4>
                    <ul className="text-white leading-none flex flex-col gap-4">
                    <li className="duration-100 hover:text-primary inline-block group">
                        <a className="text-underline-primary" href="shop-v1.html">
                        Shop
                        </a>
                    </li>
                    <li className="duration-100 hover:text-primary inline-block group">
                    ...
                    <li className="duration-100 hover:text-primary inline-block group">
                        <a className="text-underline-primary" href="cart.html">
                        Cart
                        </a>
                    </li>
                    <li className="duration-100 hover:text-primary inline-block group">
                        <a className="text-underline-primary" href="checkout.html">
                        Checkout
                        </a>
                    </li>
                    <li className="duration-100 hover:text-primary inline-block group">
                        <a className="text-underline-primary" href="#">
                        Wishlist
                        </a>
                    </li>
                    </ul>
                ...
                <div className="">
                    ...
                    <ul className="text-white leading-none flex flex-col gap-4">
                    <li className="duration-100 hover:text-primary inline-block group">
                        <a className="text-underline-primary" href="faq.html">
                        FAQs
                        </a>
                    </li>
                    <li className="duration-100 hover:text-primary inline-block group">
                    ...
                    <li className="duration-100 hover:text-primary inline-block group">
                        <a className="text-underline-primary" href="contact.html">
                        Contact
                        </a>
                    </li>
                    </ul>
            ...
            <div className="max-w-[1722px] mx-auto border-t border-white border-opacity-10 py-5 md:py-7 text-center">
                ...
                Copyright © 2022 Furnixar. All rights reserved.
                </p>
            </div>
            </div>
        </div>
