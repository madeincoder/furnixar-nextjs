...
import teamImage01 from '../../../public/images/team/team-01.jpg'
import teamImage02 from '../../../public/images/team/team-02.jpg'
import teamImage03 from '../../../public/images/team/team-03.jpg'
import teamImage04 from '../../../public/images/team/team-04.jpg'
import teamImage05 from '../../../public/images/team/team-05.jpg'
import teamImage06 from '../../../public/images/team/team-06.jpg'
...
const Contact = () => {
  ...
  return (
    <>
        <Banner title='Team Member' slugTitle='Team'/>
        {/* Team Start */}
        <div className="s-py-100">
            <div className="container-fluid">
            <div className="max-w-[1720px] mx-auto grid lg:grid-cols-2 gap-[30px]">
                <div
                className="sm:grid sm:grid-cols-2 bg-[#F8F5F0] dark:bg-[#1E2A35]"
                data-aos="fade-up"
                >
                <div className="">
                    <Image
                ...
                <div className="sm:flex items-center justify-center px-5 py-[30px]">
                    <div className="sm:max-w-[294px]">
                    <h4 className="font-semibold leading-none text-xl md:text-2xl">
                        <a href="#">Luciana Sacchena</a>
                    </h4>
                    <span className="text-title dark:text-white-light leading-none mt-[10px]">
                        Product Designer
                    </span>
                    <p className="mt-[15px]">
                        Lorem ipsum dolor sit amet, consectetur purus integer elementum
                        habitant vel tempor varius.{" "}
                    </p>
                    <div className="flex items-center gap-5 md:gap-6 mt-[15px]">
                        <a
                        href="#"
                        className="hover:text-primary dark:hover:text-primary transition-all duration-300 text-paragraph dark:text-white"
                        >
                        <svg
                ...
                <div
                className="flex flex-col-reverse sm:grid sm:grid-cols-2 bg-[#F8F5F0] dark:bg-[#1E2A35]"
                data-aos="fade-up"
                data-aos-delay={200}
                >
                <div className="sm:flex items-center justify-center px-5 py-[30px]">
                ...
                <div
                className="flex flex-col-reverse lg:grid lg:grid-cols-2 bg-[#F8F5F0] dark:bg-[#1E2A35] sm:flex-row-reverse lg:flex-row"
                data-aos="fade-up"
                >
                <div className="sm:flex items-center justify-center px-5 py-[30px] sm:w-1/2 lg:w-auto">
                    <div className="sm:max-w-[294px]">
                    <h4 className="font-semibold leading-none text-xl md:text-2xl">
                        <a href="#">Flacxia Piano</a>
                    </h4>
                    <span className="text-title dark:text-white-light leading-none mt-[10px]">
                        Interior Designer
                    </span>
                ...
                <div
                className="flex flex-col lg:grid lg:grid-cols-2 bg-[#F8F5F0] dark:bg-[#1E2A35] sm:flex-row-reverse lg:flex-row"
                data-aos="fade-up"
                data-aos-delay={200}
                >
                <div className="sm:w-1/2 lg:w-auto">
